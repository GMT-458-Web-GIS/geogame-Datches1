...
import {
  ...
  replaceNode,
  shared
} from "./chunk-FWGJY2CX.js";
import {
  CollectionEventType_default,
  Collection_default
} from "./chunk-ULO7FRW2.js";
...
import {
  ...
  toPromise,
  unlistenByKey
} from "./chunk-KV7OJPU7.js";
import {
  clamp,
  clear
} from "./chunk-NBTO6RCT.js";
...
var MapBrowserEventType_default = {
   ...
   * @api
   */
  CLICK: EventType_default2.CLICK,
  /**
   * A true double click, with no dragging.
   * @event module:ol/MapBrowserEvent~MapBrowserEvent#dblclick
   * @api
   */
  DBLCLICK: EventType_default2.DBLCLICK,
  /**
...
var TileQueue = class extends PriorityQueue_default {
  ...
  enqueue(element) {
    ...
    if (added) {
      ...
      tile.addEventListener(EventType_default2.CHANGE, this.boundHandleTileChange_);
    }
    return added;
  }
  /**
  ...
  handleTileChange(event) {
    ...
    if (state === TileState_default.LOADED || state === TileState_default.ERROR || state === TileState_default.EMPTY) {
      if (state !== TileState_default.ERROR) {
        tile.removeEventListener(EventType_default2.CHANGE, this.boundHandleTileChange_);
      }
...
var KeyboardPan = class extends Interaction_default {
  ...
  handleEvent(mapBrowserEvent) {
    let stopEvent = false;
    if (mapBrowserEvent.type == EventType_default2.KEYDOWN) {
      const keyEvent = (
        /** @type {KeyboardEvent} */
        mapBrowserEvent.originalEvent
      );
...
var KeyboardZoom = class extends Interaction_default {
  ...
  handleEvent(mapBrowserEvent) {
    let stopEvent = false;
    if (mapBrowserEvent.type == EventType_default2.KEYDOWN || mapBrowserEvent.type == EventType_default2.KEYPRESS) {
      const keyEvent = (
        /** @type {KeyboardEvent} */
        mapBrowserEvent.originalEvent
      );
...
var MouseWheelZoom = class extends Interaction_default {
  ...
  handleEvent(mapBrowserEvent) {
    ...
    if (type !== EventType_default2.WHEEL) {
      return true;
    }
    const map = mapBrowserEvent.map;
    const wheelEvent = (
...
var LayerGroup = class _LayerGroup extends Base_default {
  ...
  registerLayerListeners_(layer) {
    const listenerKeys = [
      ...
      listen(layer, EventType_default2.CHANGE, this.handleLayerChange_, this)
    ];
...
var Map = class extends Object_default {
  ...
  handleMapBrowserEvent(mapBrowserEvent) {
    ...
    if (eventType === EventType_default3.POINTERDOWN || eventType === EventType_default2.WHEEL || eventType === EventType_default2.KEYDOWN) {
  ...
  handlePostRender() {
    ...
    if (frameState && this.renderer_ && !frameState.animate) {
      if (this.renderComplete_) {
        if (this.hasListener(EventType_default.RENDERCOMPLETE)) {
          this.renderer_.dispatchRenderEvent(
            EventType_default.RENDERCOMPLETE,
            frameState
          );
        }
  ...
  handleTargetChanged_() {
    ...
    if (this.mapBrowserEventHandler_) {
      ...
      this.viewport_.removeEventListener(
        EventType_default2.CONTEXTMENU,
        this.boundHandleBrowserEvent_
      );
      this.viewport_.removeEventListener(
        EventType_default2.WHEEL,
        this.boundHandleBrowserEvent_
      );
    ...
    if (!targetElement) {
      ...
      if (!isCanvas(targetElement)) {
        ...
        this.targetChangeHandlerKeys_ = [
          listen(
            keyboardEventTarget,
            EventType_default2.KEYDOWN,
            this.handleBrowserEvent,
            this
          ),
          listen(
            keyboardEventTarget,
            EventType_default2.KEYPRESS,
            this.handleBrowserEvent,
            this
          )
        ];
  ...
  handleLayerGroupChanged_() {
    ...
    if (layerGroup) {
      ...
      this.layerGroupPropertyListenerKeys_ = [
        ...
        listen(layerGroup, EventType_default2.CHANGE, this.render, this),
